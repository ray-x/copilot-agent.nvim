...
| `/mcp`                 | `[add\|show\|edit\|delete\|disable\|enable\|reload] ...` | Manage MCP servers in `.mcp.json` / `.vscode/mcp.json`: add/show/edit/delete entries, toggle disabled state, and reconnect the active session to reload discovery                      |
