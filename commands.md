...
| `/session`             | **Yes**     |     **Yes** | Bare `/session` opens the picker; `/session info|checkpoints|files|plan|rename|cleanup|prune|delete` handles session inspection and maintenance |
