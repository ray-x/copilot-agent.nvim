...
local state = {
  ...
  compose_bufnr = nil,
  compose_winid = nil,
  _toggle_restore_input = false, -- reopen prompt input when chat is toggled back on
  _toggle_restore_compose = false, -- reopen compose split when chat is toggled back on
  ...
  post_tool_use_hooks = {}, -- active postToolUse hook metadata keyed by hookInvocationId
